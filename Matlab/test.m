...
%%  === EDIT THESE ===
    ...
    specific_heat_ratio = 1.67; % 1.4 for air
    molar_mass = .1313; % .0289645 for air
    molar_mass_units = '[kg/mol]';
    
    % chamber conditions
    chamber_temperature = 273;
    temperature_units = '[K]';
    chamber_pressure = 101325; % 1.01325 bar = 1 atm
    pressure_units = '[Pa]';
    
    % nozzle geometry
    exit_radius = .025; % radius at nozzle exit
    throat_radius = .0179; % radius at nozzle throat
    length_units = '[m]';
